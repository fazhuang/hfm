...
#: SCHEMA the import writes into, not the frozen mapping/import logic, so it
#: advances with each authorized migration: leaving it behind makes the tool
#: refuse to run against an already-migrated database at all. The frozen
#: counts below are unchanged.
EXPECTED_MIGRATION_HEAD = "0018"
