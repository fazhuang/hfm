...
<template>
  <section class="heritage" aria-labelledby="heritage-heading">
    ...
    <!-- HISTORICAL_TEXTUAL_CONTEXT（历史文献语境） -->
    <section
      class="heritage-context heritage-context--historical"
      aria-labelledby="historical-context-heading"
    >
      <h2 id="historical-context-heading" class="heritage-context__title">
        HISTORICAL_TEXTUAL_CONTEXT · 历史文献语境
      </h2>
      <p class="heritage-context__note">
        历史文献语境：皇甫谧（针灸鼻祖）源头史料与已确认谱系节点。第二代至第五代谱系结构化整理中，不虚构。
      </p>

      <!-- 09 传承谱系 -->
      <section class="heritage-section" aria-labelledby="lineage-heading">
        <h3 id="lineage-heading" class="section-title">传承谱系</h3>
    ...
    <!-- CONTEMPORARY_LIVING_ARCHIVE_CONTEXT（当代活态档案语境） -->
    <section
      class="heritage-context heritage-context--contemporary"
      aria-labelledby="contemporary-context-heading"
    >
      <h2 id="contemporary-context-heading" class="heritage-context__title">
        CONTEMPORARY_LIVING_ARCHIVE_CONTEXT · 当代活态档案语境
      </h2>
      <p class="heritage-context__note">
        当代活态档案语境：非遗项目、传承人物、认定与荣誉、学术与技术成果、师承教育、名中医工作室、媒体报道（客户资料，逐条注明公开来源）。
      </p>

      <!-- 02 非遗项目 -->
      <section class="heritage-section" aria-labelledby="project-heading">
        <h3 id="project-heading" class="section-title">非遗项目</h3>
      ...
      <section id="profile" class="heritage-section" aria-labelledby="profile-heading">
        <h3 id="profile-heading" class="section-title">传承人物档案</h3>
        <article class="person-profile">
          ...
          <div class="person-profile__roles">
            <h4 class="person-profile__sub">学术任职</h4>
            <ul>
      ...
      <!-- 04 认定与荣誉（secondary metadata，非荣誉墙） -->
      <section class="heritage-section" aria-labelledby="recognition-heading">
        <h3 id="recognition-heading" class="section-title">认定与荣誉</h3>
      ...
      <section class="heritage-section" aria-labelledby="achievements-heading">
        <h3 id="achievements-heading" class="section-title">学术与技术成果</h3>

        <h4 class="sub-title">学术成果</h4>
      ...
      <section id="apprenticeship" class="heritage-section" aria-labelledby="apprenticeship-heading">
        <h3 id="apprenticeship-heading" class="section-title">师承教育</h3>
      ...
      <section id="studios" class="heritage-section" aria-labelledby="studios-heading">
        <h3 id="studios-heading" class="section-title">名中医工作室</h3>
      ...
      <section id="media" class="heritage-section" aria-labelledby="media-heading">
        <h3 id="media-heading" class="section-title">媒体报道</h3>
        <ul class="media-list">
      ...
      <section class="heritage-section" aria-labelledby="timeline-heading">
        <h3 id="timeline-heading" class="section-title">重要时间节点</h3>
      ...
      <section class="heritage-section" aria-labelledby="evidence-heading">
        <h3 id="evidence-heading" class="section-title">来源与证据</h3>
        <p class="evidence-note">
          本页全部记录来自客户提供的非遗传承申报档案材料，各条记录已注明公开来源名；
...
/* UX2-P3: two evidence-context bands (G1-A §4) */
.heritage-context {
  margin: 0 0 var(--hfm-space-12);
  padding: var(--hfm-space-5) var(--hfm-space-6);
  border-left: 3px solid var(--hfm-color-border-strong);
  border-radius: 0 var(--hfm-radius-md) var(--hfm-radius-md) 0;
  background: var(--hfm-color-surface);
}

.heritage-context--historical {
  border-left-color: var(--hfm-color-evidence);
}

.heritage-context--contemporary {
  border-left-color: var(--hfm-color-citation);
}

.heritage-context__title {
  font-size: var(--hfm-text-xl);
...
/* UX2-P3: PARTIAL lineage state (谱系整理中) */
.lineage-state {
  margin: 0 0 var(--hfm-space-3);
}
