...
/**
 * HomeDomainsSection — homepage Section 07 (研究导航 / Usable Archive, S7-A).
 *
 ...
 * rules; domain material as restrained holdings rows; medical numbers as a
 * scholarly bibliographic register (not KPI cards); entry CTAs share ONE
 * navigation grammar. No cards / boxes / panels / icons / photography.
 *
 * TRUTH (CF-09): every CTA resolves to a real current route; the rejected
...
<template>
  ...
  >
    ...
    <div class="home-domains__inner">
      <!-- header -->
      <p class="home-domains__eyebrow">
        <span class="home-domains__no">{{ HOME_CHAPTERS.domains.no }}</span
      ...
      <div class="home-domains__thresholds" role="list" aria-label="四域入口">
        ...
        >
          ...
          <p class="home-domains__k">{{ domain.key }} · {{ domain.en }}</p>
          ...
          <a class="home-domains__go" :href="domain.href"
            ...
            ><span class="home-domains__go-arr" aria-hidden="true">→</span></a
          >
        </div>
      </div>
...
<style scoped>
/* ===== Section 07 Domains (S7-A Refined) — fidelity, 1440×1240 ===== */
...
/* ===== Responsive (CF-09): all four thresholds reachable below 1200px. ===== */
